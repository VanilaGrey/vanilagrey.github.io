export default ({ getImages }) => ({
	...
	qualities: {
		description:
			'"Опытный фронтенд-разработчик со знанием Vue 3, Pinia, Vue Router, Composition API. Умею создавать адаптивные и отзывчивые интерфейсы, работать с REST API и продумывать архитектуру приложений. Открыт к новым задачам и всегда рад учиться и делиться опытом."',
